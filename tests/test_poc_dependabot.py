# -*- coding: utf-8 -*-
"""Tests for `poc_dependabot` package."""

import random

import pytest

from poc_dependabot import poc_dependabot
...
def test_sum_numbers(generate_numbers):
    ...
    our_result = poc_dependabot.sum_numbers(generate_numbers)
...
def test_max_number(generate_numbers):
    ...
    our_result = poc_dependabot.max_number(generate_numbers)
